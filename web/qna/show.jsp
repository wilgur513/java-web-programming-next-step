              ...
              <article class="article">
                  ...
                  <div class="article-util">
                      <ul class="article-util-list">
                          <li>
                              <a class="link-modify-article" href="/questions/update?questionid=${question.questionId}/form">수정</a>
                          </li>
                          <li>
                              <form class="form-delete" action="/questions/delete?questionId=${question.questionId}" method="POST">
              ...
              <div class="qna-comment">
                  <div class="qna-comment-slipp">
                      ...
                      <div class="qna-comment-slipp-articles">
                              ...
                              <article class="article" id="answer-1405">
                                  ...
                                  <div class="article-util">
                                      <ul class="article-util-list">
                                          ...
                                          <li>
                                              <form class="form-delete" action="/answer/delete?answerId=${answer.answerId}" method="POST">
                                                  <input type="hidden" name="_method" value="DELETE">
                          ...
                          <form class="submit-write" action="/answer?questionId=${questionId}">
