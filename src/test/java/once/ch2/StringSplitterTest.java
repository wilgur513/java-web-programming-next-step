...
public class StringSplitterTest {
    ...
    public void shouldSplitComma() {
        StringSplitter splitter = new StringSplitter(new StringExpression("1,2,3,4"));
        assertThat(splitter.split(), containsInAnyOrder("1", "2", "3", "4"));
    }

    @Test
    public void shouldSplitColon() {
        StringSplitter splitter = new StringSplitter(new StringExpression("2:4"));
        assertThat(splitter.split(), containsInAnyOrder("2", "4"));
    }

    @Test
    public void shouldSplitCommaAndColon() {
        StringSplitter splitter = new StringSplitter(new StringExpression("1,2,5:7,3:4"));
        assertThat(splitter.split(), containsInAnyOrder("1", "2", "5", "7", "3", "4"));
    }

    @Test
    public void shouldSplitDuplicateNumber() {
        StringSplitter splitter = new StringSplitter(new StringExpression("1,2,3:6,5,6"));
